...
const SUBGRAPH = 'https://api.goldsky.com/api/public/project_clus2fndawbcc01w31192938i/subgraphs/mainnet-voting-v2/0.1.1/gn'
const PAGE = 1000
...
export function roundSlashStats(
    slashes: VoteSlashes,
    requests: Array<{ identifier: `0x${string}`; time: bigint; ancillaryData: `0x${string}` }>,
